...
* **Android App:** [Download APK (Beta/Debug)](https://github.com/am-trouzine/T-Tasks-Timer/releases/download/v1.0.0/app-debug.apk)
...
* **Application Android :** [Télécharger l'APK (Bêta/Debug)](https://github.com/am-trouzine/T-Tasks-Timer/releases/download/v1.0.0/app-debug.apk)
...
* **تطبيق أندرويد:** [تحميل ملف APK (نسخة تجريبية)](https://github.com/am-trouzine/T-Tasks-Timer/releases/download/v1.0.0/app-debug.apk)
...
| :---: | :---: | :---: |
| ![KitKat](screenshots/android-kitkat.png) | ![Android 13](screenshots/android-modern.png) | ![PC](screenshots/desktop-browser.png) |
